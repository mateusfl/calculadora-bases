...
if operacao == 'c':
    ...
    b1, b2 = map(int, input("Digite a base de origem e a base de destino separadas por espaço: ").split(" "))
else:
...
match operacao:
    ...
    case "c":
       print(f"O valor {n}({b1}) é igual a {decimal_para_base(str(base_para_decimal(n, b1)), b2)}({b2})")
    case _:
